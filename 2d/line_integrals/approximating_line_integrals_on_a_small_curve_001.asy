...
vec2.Vec2 start = vec2.Vec2(2.0, 0.0);
vec2.Vec2 finish = vec2.Vec2(1.0, 2.0);
...
vec2.Vec2 axis_start = vec2.Vec2(0.0, 0.0);
...
draw(start.LineTo(finish), default.blue_pen, default.sharp_arrow);
