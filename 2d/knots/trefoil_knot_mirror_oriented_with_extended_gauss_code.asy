...
draw(graph(tref, -1.29, -0.35), default.mid_sharp_arrow);
draw(graph(tref, -0.35, 0.75), default.mid_sharp_arrow);
draw(graph(tref, 0.8, 1.6), default.mid_sharp_arrow);
draw(graph(tref, 1.6, 2.85), default.mid_sharp_arrow);
draw(graph(tref, 2.9, 3.45), default.mid_sharp_arrow);
draw(graph(tref, 3.45, 4.94), default.mid_sharp_arrow);
...
label("U0- O1- U2- O0- U1- O2-", (0.0, -2.8));
