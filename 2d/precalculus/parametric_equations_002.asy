 ...
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Plots the parametric curve (1-(1/2)t^2, 1-(1/3)t^3).                  *
 ******************************************************************************/
...
int grid_start = -1;
int grid_end = 2;
vec2.Vec2 start = vec2.Vec2(-2.2, -1.2);
vec2.Vec2 end = vec2.Vec2(2.4, 3.2);

/*  Number of samples used in drawing the parabola.                           */
int samples = 20;

/*  Create a path from the function.                                          */
path plot = pc.PathFromParametricFunction(curve, 0.0, 1.732050807, samples);
...
label("$\gamma(t)=(1+3t^{2},\,2+2t^{3})$", (1.4, 0.6));
