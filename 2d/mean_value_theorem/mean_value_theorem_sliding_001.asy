...
{
    real t = (real)n / (real)number_of_lines;
    vec2.Vec2 left = vec2.PointOnLine(t, P0, Q0);
    vec2.Vec2 right = vec2.PointOnLine(t, P1, Q1);
    pen p = t*blue + (1.0 - t)*red + linewidth(0.2) + opacity(0.8);
    draw(left.LineTo(right), p);
}
