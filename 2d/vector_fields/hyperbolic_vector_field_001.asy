 ...
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Draws a hyperbolic vector field (flow lines are cosh and sinh).       *
 ******************************************************************************/
...
/*  The vector field to be drawn. It follows hyperbolic flow lines.           */
vec2.Vec2 vector_field(vec2.Vec2 point)
{
    real factor = 0.125;
    return factor * vec2.Vec2(point.y, point.x);
}
