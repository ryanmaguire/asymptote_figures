 ...
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Plots y = x - 2x^3 + 2x^5 on [0, 1] with a vector field along it.     *
 ******************************************************************************/
...
vec2.Vec2 gamma_label = vec2.Vec2(0.8, 0.1);
...
vec2.Vec2 field_label = vec2.Vec2(0.7, 0.6);
...
for (n = 0; n < number_of_arrows; ++n)
{
    ...
    /*  The vector field, which depends only on x.                            */
    vec2.Vec2 field = 0.125 * tail.ProjectX();
    ...
    vec2.Vec2 field_head = tail + field;
    ...
    draw(tail.LineTo(field_head), default.gray_thin_pen, default.sharp_arrow);
}
